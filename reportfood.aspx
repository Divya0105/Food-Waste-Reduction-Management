<%@ Page Language="VB" AutoEventWireup="false" CodeFile="reportfood.aspx.vb" Inherits="reportfood" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Names="Agency FB" Font-Size="35pt"
            ForeColor="#004040" Style="z-index: 101; left: 495px; position: absolute; top: 38px"
            Text="Donation Details" Width="261px"></asp:Label>
        <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
        <asp:GridView ID="GridView1" runat="server" DataSourceID="AccessDataSource3" Style="z-index: 103;
            left: 42px; position: absolute; top: 141px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" Height="82px" Width="1198px">
